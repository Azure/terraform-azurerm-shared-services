...
if [ -z "${TF_VAR_azure_devops_organisation}" ]; then
  echo
  echo "TF_VAR_azure_devops_organisation not set."
...
if [ -z "${TF_VAR_azure_devops_project}" ]; then
  echo
  echo "TF_VAR_azure_devops_project not set."
...
if [ -z "${TF_VAR_azure_devops_pat}" ]; then
  echo
  echo "TF_VAR_azure_devops_pat not set."
